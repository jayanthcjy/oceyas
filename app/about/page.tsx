  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-[#C7DDEB] to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-[#2B4470] mb-6">About Oceyas Physio & Rehab</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold text-[#2B4470] mb-6">Our Story</h2>
              ...
              <button
                ...
                className="bg-[#D04A6B] hover:bg-[#348AC7] text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 flex items-center gap-3"
              >
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="text-center p-8 bg-[#C7DDEB] rounded-2xl">
              <div className="bg-[#348AC7] p-4 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-6">
                <Target className="text-white" size={32} />
              </div>
              <h3 className="text-2xl font-bold text-[#2B4470] mb-4">Our Mission</h3>
              <p className="text-[#348AC7] leading-relaxed">
            ...
            <div className="text-center p-8 bg-[#C7DDEB] rounded-2xl">
              ...
              <h3 className="text-2xl font-bold text-[#2B4470] mb-4">Our Vision</h3>
              <p className="text-[#348AC7] leading-relaxed">
      ...
      <section className="py-16 px-4 bg-[#C7DDEB]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#2B4470] mb-4">Our Values</h2>
            <p className="text-[#348AC7] text-lg">The principles that guide everything we do</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
              <h3 className="text-xl font-bold text-[#2B4470] mb-4">Excellence</h3>
              <p className="text-gray-600">
                We strive for the highest standards in everything we do, from treatment quality to patient experience.
              </p>
            </div>
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
              <h3 className="text-xl font-bold text-[#2B4470] mb-4">Compassion</h3>
              <p className="text-gray-600">
                We treat every patient with empathy, understanding, and genuine care for their well-being.
              </p>
            </div>
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
              <h3 className="text-xl font-bold text-[#2B4470] mb-4">Innovation</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#348AC7] text-lg">Experienced professional dedicated to your recovery</p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="text-center p-4 bg-[#C7DDEB] rounded-xl">
                    <Award className="text-[#348AC7] mx-auto mb-2" size={32} />
                    <h4 className="text-2xl font-bold text-[#2B4470]">12+</h4>
                    <p className="text-[#348AC7] text-sm">Years Experience</p>
                  </div>
                  <div className="text-center p-4 bg-[#C7DDEB] rounded-xl">
                    <Users className="text-[#348AC7] mx-auto mb-2" size={32} />
                    <h4 className="text-2xl font-bold text-[#2B4470]">5K+</h4>
                    <p className="text-[#348AC7] text-sm">Happy Patients</p>
                  </div>
                </div>
      ...
      <section className="py-16 px-4 bg-[#C7DDEB]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#2B4470] mb-6">Ready to Start Your Recovery?</h2>
          <p className="text-[#348AC7] text-lg mb-8 max-w-2xl mx-auto">
          ...
          <button
            onClick={handleWhatsApp}
            className="bg-[#D04A6B] hover:bg-[#348AC7] text-white px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3 mx-auto"
          >
